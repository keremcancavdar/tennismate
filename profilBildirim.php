    ...
    <div class="row justify-content-between ">
        <div class="col-7 profilSol p-5">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-9">
                    <h4>Kurduğunuz Oyunlar</h4>
                </div>
                <?php

            $aktifOyun = $baglan->query("SELECT * FROM aktifoyunlar WHERE kurucuID = '$uyeID'");
                ...
                <div class="col-9 oyunTeklif mt-2">
                    <div class="row">
                        ...
                        <div class="col-6 p-3" style="height:100px;">
                            <b> <?php echo $aktifOyunSonuc["tarih"]." - ".$aktifOyunSonuc["saat"]; ?></b> tarihinde,
                            Pamukkale
                            Üniversitesi
                            Sosyal
                        ...
                        <div class="col-4 align-self-center text-center">
                            <a href="inc/oyunSil.php?oyunID=<?=$aktifOyunSonuc['oyunID'];?>"><button type="button"
                                    class="btn btn-danger">İptal Et</button></a>
                        </div>
            ...
            if($davetSayi == '0'){
                ...
                ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 p-3" style="height:100px;">
                                <a href="profilGoruntule.php?profilID=<?=$bitir_katilimciID?>"
                                    class="profilLink"><?php echo $bitir_katilimciAdSonuc['uyeAd']; ?></a> ile
                                oynadığın oyunu
                            ...
                            <div class="col-4 align-self-center text-center">
                                <a href="oyunSonlandir.php?etkinlikID=<?=$bitir_etkinlikID?>"><button type="button"
                                        class="btn btn-success">Oynandı</button></a>
                            </div>
                            <!--
                    ...
                    <div class=" col-9 mt-4 mb-2">
                        <h4> Değerlendirme Bekleyen Oyunlar</h4>
                    </div>
                    <?php
                ...
                while($deglendirme_oyunlarSonuc = $deglendirme_oyunlar->fetch_assoc()){
                    ...
                    if($uyeID == $degerlendirme_kurucuID){
                        $degerlendirme_katilimciAd = $baglan->query("SELECT uyeAd FROM uye WHERE uyeID = '$degerlendirme_katilimciID'");
                        ...
                        $degerlendirme_katilimciAd = $baglan->query("SELECT uyeAd FROM uye WHERE uyeID = '$degerlendirme_kurucuID'");
                        $degerlendirme_katilimciAdSonuc = $degerlendirme_katilimciAd->fetch_assoc();
                        // Sadece karşı tarafın ismine erişiyor
                    ...
                    <div class=" col-9 oyunTeklif mb-3">
                        <div class="row">
                            ...
                            <div class="col-4 align-self-center text-center">
                                ...
                                <a href='degerlendir.php?etkinlikID=<?=$degerlendirme_etkinlikID?>&rol=<?=$rol?>'><button
